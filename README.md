...
**[Завантажити ASKOD Звіти](https://maksym5248.github.io/askod-reports/)** — інсталятори останньої версії для Windows та Ubuntu. Збірки macOS додаються окремо.

[Усі релізи та файли](https://github.com/Maksym5248/askod-reports/releases).
...
- [Шаблони звітів](docs/report-templates.md) — XLS/DOCX, доступні показники та відсутні дані.
- [Desktop-збірки](docs/desktop-builds.md) — Windows, Ubuntu та macOS, пакування й перевірка дистрибутивів.
