...
Він використовує звичайну desktop-базу без імпорту нових даних; знімок зберігається
в `.data/desktop-smoke.png`. Закрийте інше вікно цього застосунку перед smoke test.
